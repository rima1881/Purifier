...
pub fn build(b: *std.Build) void {
    ...
    const maryam_dep = b.dependency("maryam", .{
        .target = target,
        .optimize = optimize,
    });
    ...
    const mod = b.addModule("Purifier", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "Purifier" is the name you will use in your source code to
                // import this module (e.g. `@import("Purifier")`). The name is
